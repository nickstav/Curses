...
>
    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" class="p-3" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke={toolsIconCol}>
    ...
    >
        <svg xmlns="http://www.w3.org/2000/svg" class="p-3" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke={exportIconCol}>
