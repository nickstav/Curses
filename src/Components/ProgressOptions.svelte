...
<div id="progressOptions" class="w-1/2 h-8 text-xs flex flex-row justify-center bg-gray-200 m-1 border border-black">
    ...
    <div id="checkbox" class="flex flex-row items-center">
        ...
        <label for="showPerc" class="ml-1">Show percentage value</label>
    </div>
</div>